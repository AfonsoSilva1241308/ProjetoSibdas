                        ...
                        <form action="atualizar_indicadores.php" method="POST" class="form-editar-conteudo">
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" name="num_instituicoes" class="form-control bg-light border-0" id="numInstituicoes" value="<?= htmlspecialchars($site_info['num_instituicoes'] ?? '45') ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" name="num_dispositivos" class="form-control bg-light border-0" id="numDispositivos" value="<?= htmlspecialchars($site_info['num_dispositivos'] ?? '1200') ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group shadow-sm">
                                        <input type="number" name="perc_monitorizacao" class="form-control bg-light border-0" id="percMonitorizacao" value="<?= htmlspecialchars($site_info['perc_monitorizacao'] ?? '45') ?>">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group shadow-sm">
                                        <input type="number" name="perc_suporte" class="form-control bg-light border-0" id="percSuporteVida" value="<?= htmlspecialchars($site_info['perc_suporte'] ?? '35') ?>">
                                        <span class="input-group-text bg-light border-0">%</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group shadow-sm">
                                        <input type="number" name="perc_terapia" class="form-control bg-light border-0" id="percTerapia" value="<?= htmlspecialchars($site_info['perc_terapia'] ?? '12') ?>">
                                        <span class="input-group-text bg-light border-0">%</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group shadow-sm">
                                        <input type="number" name="perc_diagnostico" class="form-control bg-light border-0" id="percDiagnostico" value="<?= htmlspecialchars($site_info['perc_diagnostico'] ?? '8') ?>">
                                        <span class="input-group-text bg-light border-0">%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-4 align-items-center mb-3">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <div class="border rounded-3 overflow-hidden shadow-sm">
                                        <img src="<?= htmlspecialchars($site_info['banner_imagem'] ?? '../../assets/img/hospital.png') ?>" alt="Pré-visualização do Banner" class="img-fluid" style="height: 100px; width: 100%; object-fit: cover;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="accordion-body p-4 bg-white border-top">
                        <form action="atualizar_contactos.php" method="POST" class="form-editar-conteudo">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="titulo_form" class="form-control bg-light border-0 shadow-sm mb-2" id="tituloContacto" value="<?= htmlspecialchars($site_info['titulo_form'] ?? 'Tem alguma dúvida? Fale connosco.') ?>">
                                
                                <label for="textoContacto" class="form-label fw-medium text-secondary mt-2">Mensagem de Apoio</label>
                                <textarea name="texto_apoio" class="form-control bg-light border-0 shadow-sm" id="textoContacto" rows="2"><?= htmlspecialchars($site_info['texto_apoio'] ?? 'A nossa equipa especializada está totalmente disponível para esclarecer qualquer questão relacionada com a plataforma, a sua implementação ou a gestão da engenharia clínica do seu hospital. Envie-nos a sua mensagem!') ?></textarea>
                            </div>

                            <div class="row g-4 mb-3">
                                <div class="col-12">
                                    <h6 class="text-dark fw-bold border-bottom pb-2 mb-3">Localização (Rodapé)</h6>
                                    <input type="text" name="morada_rua" class="form-control bg-light border-0 shadow-sm mb-2" id="moradaRua" value="<?= htmlspecialchars($site_info['morada_rua'] ?? 'Rua Dr. António Bernardino de Almeida, 431') ?>">
                                    <input type="text" name="morada_cod_postal" class="form-control bg-light border-0 shadow-sm" id="moradaCodPostal" value="<?= htmlspecialchars($site_info['morada_cod_postal'] ?? '4200-072, Porto') ?>">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="horario_semana" class="form-control bg-light border-0 shadow-sm mb-2" id="horarioSemana" value="<?= htmlspecialchars($site_info['horario_semana'] ?? '2ª a 6ª Feira: 8h30 — 18h30') ?>">
                                    <label class="form-label small text-secondary mb-1">Fim de Semana</label>
                                    <input type="text" name="horario_fim_semana" class="form-control bg-light border-0 shadow-sm" id="horarioSabado" value="<?= htmlspecialchars($site_info['horario_fim_semana'] ?? 'Sábado: 9h00 — 13h00') ?>">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email_contato" class="form-control bg-light border-0 shadow-sm mb-2" id="emailPublico" value="<?= htmlspecialchars($site_info['email_contato'] ?? 'geral@medilinkdigital.pt') ?>">
                                    <label class="form-label small text-secondary mb-1">Telefone</label>
                                    <input type="text" name="telefone_contato" class="form-control bg-light border-0 shadow-sm" id="telefonePublico" value="<?= htmlspecialchars($site_info['telefone_contato'] ?? '+351 220 121 022') ?>">
                                </div>
                            </div>
                            <div class="text-end mt-4">

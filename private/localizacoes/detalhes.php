...
<head>
    ...
    <title>Detalhes da Localização — MediLink Digital</title>
                                    ...
                                    <table class="table align-middle mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="../equipamentos/detalhes.html" class="btn btn-sm btn-outline-secondary" title="Ver Ficha do Equipamento">
